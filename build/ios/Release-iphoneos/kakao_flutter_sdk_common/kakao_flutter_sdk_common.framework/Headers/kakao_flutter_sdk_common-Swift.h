...
#ifndef KAKAO_FLUTTER_SDK_COMMON_SWIFT_H
#define KAKAO_FLUTTER_SDK_COMMON_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="kakao_flutter_sdk_common",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
